...
<a href="https://query.hisqu.de/" target="_blank" rel="noopener noreferrer" class="inline-flex items-center rounded-lg bg-purple-600 px-5 py-3 font-semibold !text-white !no-underline transition-colors hover:bg-purple-500">Query by Graph ausprobieren →</a>
